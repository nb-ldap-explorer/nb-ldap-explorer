 ...
 */
package dk.i2m.netbeans.modules.ldapexplorer.security;
...
/**
 * Trust {@link Provider} for accepting self-signed SSL certificates. Found at
 * {@link http://devcentral.f5.com/weblogs/joe/archive/2005/07/06/1345.aspx}.
 */
public final class XTrustProvider extends java.security.Provider {
    ...
    public XTrustProvider() {
        ...
        AccessController.doPrivileged(new PrivilegedAction() {
            ...
            public Object run() {
                put("TrustManagerFactory." + TrustManagerFactoryImpl.
                        getAlgorithm(), TrustManagerFactoryImpl.class.getName());
                return null;
            }
        });
    }
